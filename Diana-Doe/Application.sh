...
gsettings set org.gnome.desktop.background picture-uri "file:///home/$USER/blood-and-milk/image/black.png"
...
conky -c ~/blood-and-milk/conky_biclock.rc &
conky -c ~/blood-and-milk/file.rc &
